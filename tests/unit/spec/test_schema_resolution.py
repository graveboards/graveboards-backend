...
class TestSchemaResolution:
    ...
    @pytest.fixture
    def mock_spec(self) -> dict[str, Any]:
    ...
    def test_get_filter_schema_with_model_class(self, mock_spec: dict[str, Any]) -> None:
    ...
    def test_get_filter_schema_with_schema_name(self, mock_spec: dict[str, Any]) -> None:
    ...
    def test_get_include_schema_with_model_class(self, mock_spec: dict[str, Any]) -> None:
    ...
    def test_get_include_schema_with_schema_name(self, mock_spec: dict[str, Any]) -> None:
    ...
    def test_get_schema_by_suffix_invalid_arguments(self, mock_spec: dict[str, Any]) -> None:
    ...
    def test_get_schema_by_suffix_suffix_mismatch(self, mock_spec: dict[str, Any]) -> None:
        """Test that _get_schema_by_suffix validates suffix."""
        with pytest.raises(ValueError):
            _get_schema_by_suffix("Filter", schema_name="TestInclude")

    def test_get_schema_by_suffix_schema_not_found(self, mock_spec: dict[str, Any]) -> None:
        """Test that _get_schema_by_suffix raises for missing schema."""
        with pytest.raises(ValueError):
            _get_schema_by_suffix("Filter", schema_name="NonExistentFilter")

    def test_get_schema_by_suffix_resolves_by_model(self, mock_spec: dict[str, Any]) -> None:
    ...
    def test_get_schema_by_suffix_resolves_by_name(self, mock_spec: dict[str, Any]) -> None:
    ...
    def test_get_filter_schema_invalid_arguments(self) -> None:
    ...
    def test_get_include_schema_invalid_arguments(self) -> None:
    ...
    def test_schema_caching_with_lru(self, mock_spec: dict[str, Any]) -> None:
    ...
    def test_schema_properties_accessible(self, mock_spec: dict[str, Any]) -> None:
    ...
    def test_schema_respects_suffix_convention(self, mock_spec: dict[str, Any]) -> None:
    ...
    def test_multiple_schema_calls_independent(self, mock_spec: dict[str, Any]) -> None:
    ...
    def test_schema_not_cached_between_processes(self, mock_spec: dict[str, Any]) -> None:
