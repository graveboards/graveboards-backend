...
class TestRegistryAllValidators:
    ...
    def test_tier_assignments_correct(self):
        ...
        assert RULE_TIERS["beatmap_duration"] == 2
        assert RULE_TIERS["beatmap_star_rating"] == 2
        assert RULE_TIERS["beatmap_bpm"] == 2
        assert RULE_TIERS["beatmap_genre"] == 2
    ...
    def test_register_validator(self):
        ...
        assert RULE_TIERS["fake_test_type"] == 2
        assert get_validator("fake_test_type") is FakeValidator

        RULE_REGISTRY.pop("fake_test_type", None)
