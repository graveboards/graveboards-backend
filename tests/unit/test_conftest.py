...
class TestConftestFixtures:
    ...
    def test_security_disabled_fixture(self, security_disabled: Callable[[], Any]) -> None:
    ...
    def test_security_enabled_restores_after(self) -> None:
