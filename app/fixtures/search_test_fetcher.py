...
class SearchTestFixtureFetcher(FixtureDataFetcher):
    ...
    # ------------------------------------------------------------------
    # Adaptive fetch methods (used by search_coverage.py priority engine)
    # ------------------------------------------------------------------

    async def _adaptive_fetch_beatmapsets(self) -> dict[str, set[int]]:
        """Fetch one random beatmapset via search (used by adaptive engine)."""
        import random
    ...
    async def _adaptive_fetch_beatmaps(self) -> dict[str, set[int]]:
        """Fetch one random beatmap (used by adaptive engine)."""
        from app.fixtures.utils import get_fixture_path
    ...
    async def _adaptive_fetch_users(self) -> dict[str, set[int]]:
        """Fetch one random user from rankings (used by adaptive engine)."""
        from app.fixtures.utils import get_fixture_path
    ...
    async def _adaptive_fetch_special(self) -> dict[str, set[int]]:
