...
SCOPE_OPTIONS_MAPPING = {
    Scope.BEATMAPS: (
        ...
        selectinload(BeatmapSnapshot.beatmapset_snapshots).options(
    ...
    Scope.BEATMAPSETS: (
        selectinload(BeatmapsetSnapshot.beatmap_snapshots).options(
            selectinload(BeatmapSnapshot.beatmap_tags),
            selectinload(BeatmapSnapshot.owner_profiles),
    ...
    Scope.QUEUES: (
        ...
        selectinload(Queue.requests).options(
            joinedload(Request.beatmapset_snapshot).options(
                selectinload(BeatmapsetSnapshot.beatmap_snapshots).options(
                    selectinload(BeatmapSnapshot.beatmap_tags),
                    selectinload(BeatmapSnapshot.owner_profiles),
                    noload(BeatmapSnapshot.beatmapset_snapshots),
...
CATEGORY_MODEL_FIELDS_MAPPING = {
    SearchableFieldCategory.BEATMAP: {"version": ModelField.BEATMAPSNAPSHOT__VERSION},
    SearchableFieldCategory.BEATMAPSET: {
    ...
    SearchableFieldCategory.REQUEST: {"comment": ModelField.REQUEST__COMMENT},
}
