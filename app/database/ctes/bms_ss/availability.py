"""CTE projecting download-disabled availability for beatmapset snapshots."""
...
availability_download_disabled_cte = select(
...
availability_more_information_cte = select(
    BeatmapsetSnapshot.id.label("beatmapset_snapshot_id"),
