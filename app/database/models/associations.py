...
beatmapset_tag_beatmapset_snapshot_association = Table(
    ...
    Column("beatmapset_tag_id", Integer, ForeignKey("beatmapset_tags.id", ondelete="CASCADE"), primary_key=True),
    Column("beatmapset_snapshot_id", Integer, ForeignKey("beatmapset_snapshots.id", ondelete="CASCADE"), primary_key=True)
)

beatmap_tag_beatmap_snapshot_association = Table(
    "beatmap_tag_beatmap_snapshot_association", Base.metadata,
    Column("beatmap_tag_id", Integer, ForeignKey("beatmap_tags.id", ondelete="CASCADE"), primary_key=True),
    Column("beatmap_snapshot_id", Integer, ForeignKey("beatmap_snapshots.id", ondelete="CASCADE"), primary_key=True)
)
