...
beatmap_snapshot_beatmapset_snapshot_association = Table(
    ...
    Column(
        "beatmapset_snapshot_id", Integer, ForeignKey("beatmapset_snapshots.id"), primary_key=True
    ),
)
...
beatmapset_tag_beatmapset_snapshot_association = Table(
    ...
    Column(
        "beatmapset_tag_id",
        Integer,
        ForeignKey("beatmapset_tags.id", ondelete="CASCADE"),
        primary_key=True,
    ),
    Column(
...
beatmap_tag_beatmap_snapshot_association = Table(
    ...
    Column(
        "beatmap_tag_id",
        Integer,
        ForeignKey("beatmap_tags.id", ondelete="CASCADE"),
        primary_key=True,
    ),
    Column(
        "beatmap_snapshot_id",
        Integer,
        ForeignKey("beatmap_snapshots.id", ondelete="CASCADE"),
        primary_key=True,
    ),
)
