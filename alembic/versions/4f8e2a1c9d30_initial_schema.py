...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_score_fetcher_tasks_user_id_users"),
            ondelete="CASCADE",
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_profile_fetcher_tasks_user_id_users"),
            ondelete="CASCADE",
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_beatmapsets_user_id_users"), ondelete="CASCADE"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "snapshot_date", sa.DateTime(timezone=True), server_default=sa.text("CURRENT_TIMESTAMP")
        ),
        ...
        sa.UniqueConstraint(
            "beatmap_id",
            "snapshot_number",
            name=op.f("uq_beatmap_snapshots_beatmap_snapshot_number"),
        ),
        sa.ForeignKeyConstraint(
            ["beatmap_id"], ["beatmaps.id"], name=op.f("fk_beatmap_snapshots_beatmap_id_beatmaps")
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_beatmap_snapshots_user_id_users")
        ),
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "beatmapset_id",
            "snapshot_number",
            name=op.f("uq_beatmapset_snapshots_beatmapset_snapshot_number"),
        ),
        sa.ForeignKeyConstraint(
            ["beatmapset_id"],
            ["beatmapsets.id"],
            name=op.f("fk_beatmapset_snapshots_beatmapset_id_beatmapsets"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_beatmapset_snapshots_user_id_users"),
            ondelete="CASCADE",
        ),
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            ...
            name=op.f("pk_beatmap_snapshot_beatmapset_snapshot_association"),
        ),
        sa.ForeignKeyConstraint(
            ["beatmap_snapshot_id"],
            ["beatmap_snapshots.id"],
            name=op.f(
                "fk_beatmap_snapshot_beatmapset_snapshot_association_beatmap_snapshot_id_beatmap_snapshots"
            ),
        ),
        sa.ForeignKeyConstraint(
            ["beatmapset_snapshot_id"],
            ["beatmapset_snapshots.id"],
            name=op.f(
                "fk_beatmap_snapshot_beatmapset_snapshot_association_beatmapset_snapshot_id_beatmapset_snapshots"
            ),
        ),
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "beatmapset_tag_id",
            "beatmapset_snapshot_id",
            name=op.f("pk_beatmapset_tag_beatmapset_snapshot_association"),
        ),
        sa.ForeignKeyConstraint(
            ["beatmapset_tag_id"],
            ["beatmapset_tags.id"],
            name=op.f(
                "fk_beatmapset_tag_beatmapset_snapshot_association_beatmapset_tag_id_beatmapset_tags"
            ),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ...
            ["beatmapset_snapshots.id"],
            name=op.f(
                "fk_beatmapset_tag_beatmapset_snapshot_association_beatmapset_snapshot_id_beatmapset_snapshots"
            ),
            ondelete="CASCADE",
        ),
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "beatmap_tag_id",
            "beatmap_snapshot_id",
            name=op.f("pk_beatmap_tag_beatmap_snapshot_association"),
        ),
        sa.ForeignKeyConstraint(
            ["beatmap_tag_id"],
            ["beatmap_tags.id"],
            name=op.f("fk_beatmap_tag_beatmap_snapshot_association_beatmap_tag_id_beatmap_tags"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["beatmap_snapshot_id"],
            ["beatmap_snapshots.id"],
            name=op.f(
                "fk_beatmap_tag_beatmap_snapshot_association_beatmap_snapshot_id_beatmap_snapshots"
            ),
            ondelete="CASCADE",
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column("beatmap_snapshot_id", sa.Integer(), nullable=False),
        sa.PrimaryKeyConstraint(
            "profile_id", "beatmap_snapshot_id", name=op.f("pk_beatmap_snapshot_owner_association")
        ),
        sa.ForeignKeyConstraint(
            ["profile_id"],
            ["profiles.id"],
            name=op.f("fk_beatmap_snapshot_owner_association_profile_id_profiles"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["beatmap_snapshot_id"],
            ["beatmap_snapshots.id"],
            name=op.f(
                "fk_beatmap_snapshot_owner_association_beatmap_snapshot_id_beatmap_snapshots"
            ),
            ondelete="CASCADE",
        ),
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "beatmap_snapshot_id", name=op.f("uq_beatmap_listings_beatmap_snapshot_id")
        ),
        sa.ForeignKeyConstraint(
            ["beatmap_id"], ["beatmaps.id"], name=op.f("fk_beatmap_listings_beatmap_id_beatmaps")
        ),
        sa.ForeignKeyConstraint(
            ["beatmap_snapshot_id"],
            ["beatmap_snapshots.id"],
            name=op.f("fk_beatmap_listings_beatmap_snapshot_id_beatmap_snapshots"),
        ),
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "beatmapset_snapshot_id", name=op.f("uq_beatmapset_listings_beatmapset_snapshot_id")
        ),
        sa.ForeignKeyConstraint(
            ["beatmapset_id"],
            ["beatmapsets.id"],
            name=op.f("fk_beatmapset_listings_beatmapset_id_beatmapsets"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["beatmapset_snapshot_id"],
            ["beatmapset_snapshots.id"],
            name=op.f("fk_beatmapset_listings_beatmapset_snapshot_id_beatmapset_snapshots"),
            ondelete="CASCADE",
        ),
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "beatmap_snapshot_id", name=op.f("uq_leaderboards_beatmap_snapshot_id")
        ),
        sa.ForeignKeyConstraint(
            ["beatmap_id"], ["beatmaps.id"], name=op.f("fk_leaderboards_beatmap_id_beatmaps")
        ),
        sa.ForeignKeyConstraint(
            ["beatmap_snapshot_id"],
            ["beatmap_snapshots.id"],
            name=op.f("fk_leaderboards_beatmap_snapshot_id_beatmap_snapshots"),
        ),
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "user_id", "beatmap_id", "created_at", name=op.f("uq_scores_user_beatmap_created_at")
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_scores_user_id_users"), ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["beatmap_id"], ["beatmaps.id"], name=op.f("fk_scores_beatmap_id_beatmaps")
        ),
        sa.ForeignKeyConstraint(
            ["beatmapset_id"], ["beatmapsets.id"], name=op.f("fk_scores_beatmapset_id_beatmapsets")
        ),
        sa.ForeignKeyConstraint(
            ["leaderboard_id"],
            ["leaderboards.id"],
            name=op.f("fk_scores_leaderboard_id_leaderboards"),
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_queues_user_id_users"), ondelete="CASCADE"
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["queue_id"],
            ["queues.id"],
            name=op.f("fk_queue_manager_association_queue_id_queues"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_queue_manager_association_user_id_users"),
            ondelete="CASCADE",
        ),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["queue_id"],
            ["queues.id"],
            name=op.f("fk_queue_rules_queue_id_queues"),
            ondelete="CASCADE",
        ),
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "beatmapset_id", "queue_id", name=op.f("uq_requests_beatmapset_id_queue_id")
        ),
        sa.ForeignKeyConstraint(
        ...
        sa.ForeignKeyConstraint(
            ["beatmapset_id"],
            ["beatmapsets.id"],
            name=op.f("fk_requests_beatmapset_id_beatmapsets"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["beatmapset_snapshot_id"],
            ["beatmapset_snapshots.id"],
            name=op.f("fk_requests_beatmapset_snapshot_id_beatmapset_snapshots"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["queue_id"],
            ["queues.id"],
            name=op.f("fk_requests_queue_id_queues"),
            ondelete="CASCADE",
        ),
    )
