...
down_revision: str | Sequence[str] | None = "4f8e2a1c9d30"
...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_beatmapset_listings_snapshot", "beatmapset_listings", ["beatmapset_snapshot_id"]
    )
    op.create_index(
        "idx_beatmapset_snapshots_beatmapset_id", "beatmapset_snapshots", ["beatmapset_id"]
    )
